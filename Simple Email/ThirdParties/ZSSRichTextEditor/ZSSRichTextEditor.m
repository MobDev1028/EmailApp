...
-(void)showToolbar {
    ...
    [self.toolbarHolder setHidden:NO];
}
...
- (void)keyboardWillShowOrHide:(NSNotification *)notification {
    ...
    /*extra height was 10 orignally
     edited by Shehriyar */
    const int extraHeight = 28;
    ...
    if ([notification.name isEqualToString:UIKeyboardWillShowNotification]) {
        ...
        [UIView animateWithDuration:duration delay:0 options:animationOptions animations:^{
            ...
            if (self.toolbarHolder.hidden) {
                
            }
            else {
                [[NSNotificationCenter defaultCenter] postNotificationName:@"simple_email_text_editor_is_active" object:nil];
            }
